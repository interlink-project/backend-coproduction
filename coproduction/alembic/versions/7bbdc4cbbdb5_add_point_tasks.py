...
def upgrade():
    ...
    op.add_column('task', sa.Column('management', sa.Integer(), nullable=False))
    ...
    op.add_column('task', sa.Column('development', sa.Integer(), nullable=False))
    ...
    op.add_column('task', sa.Column('exploitation', sa.Integer(), nullable=False))
