...
Revision ID: ae09af8c9990
Revises: 
Create Date: 2022-05-06 11:48:40.982963
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['phase_b_id'], ['phase.id'], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['objective_b_id'], ['objective.id'], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['task_b_id'], ['task.id'], ondelete='CASCADE'),
